...
export default function SignIn() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#050505] overflow-hidden px-4">
      {/* Background Orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-brand-blue-500/20 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="rounded-3xl border border-white/10 bg-[#0a0a0a]/80 backdrop-blur-xl p-8 sm:p-10 shadow-2xl">
          ...
          <div className="mb-8">
            <div className="flex justify-center mb-6">
              <div className="h-12 w-12 rounded-xl bg-gradient-to-tr from-brand-blue-500 to-purple-500 flex items-center justify-center shadow-lg shadow-brand-blue-500/20">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="text-center text-sm text-zinc-400 pt-2">
              ...
              <Link href="/sign-up" className="font-bold text-white hover:text-brand-blue-400 transition-colors">
                Sign up
              </Link>
            </div>
          </form>
